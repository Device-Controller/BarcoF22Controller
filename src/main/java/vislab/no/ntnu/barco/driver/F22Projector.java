...
import vislab.no.ntnu.barco.commands.Brightness;
import vislab.no.ntnu.barco.commands.Contrast;
import vislab.no.ntnu.barco.commands.LampRuntime;
import vislab.no.ntnu.barco.commands.LampStatus;
import vislab.no.ntnu.barco.commands.LampTimeRemaining;
import vislab.no.ntnu.barco.commands.Mute;
import vislab.no.ntnu.barco.commands.Power;
import vislab.no.ntnu.barco.commands.PowerState;
import vislab.no.ntnu.barco.commands.TestImage;
import vislab.no.ntnu.barco.commands.ThermalStatus;
import vislab.no.ntnu.barco.commands.UnitTotalTime;
...
public class F22Projector implements F22Interface, Projector {
    ...
    private static final String MAKE = "Barco";
    ...
    /**
     * Powers on the barco f22 projector.
     *
    ...
    /**
     * Powers off the barco f22 projector.
     *
    ...
    /**
     * Mutes the image on the barco f22 projector.
     * @return returns 1 if everything went like it should.
     */
    @Override
    public int mute() {
    ...
    /**
     * UnMutes the image on the barco f22 projector.
     * @return returns 0 if everything went like it should.
     */
    @Override
    public int unMute() {
